...
class ITK_TEMPLATE_EXPORT MaskedStatisticsImageFilter:
  public ImageToImageFilter< TInputImage, TInputImage >
{
public:
  ITK_DISALLOW_COPY_AND_ASSIGN(MaskedStatisticsImageFilter);

  /** Standard Self type alias */
  using Self = MaskedStatisticsImageFilter;
  ...
  using TraitsType = itk::NumericTraits<PixelType>;
  using PixelValueType = typename TraitsType::ValueType;

  using MaskImageType = itk::Image<PixelValueType, TInputImage::ImageDimension>;
  ...
  using PixelValueObjectType = SimpleDataObjectDecorator< PixelValueType >;

  itkSetObjectMacro( Mask, MaskImageType );

  itkSetMacro( RemoveNA, bool );
  itkGetMacro( RemoveNA, bool );

  /** Return the computed Minimum. */
  PixelValueType GetMinimum() const
  { return this->GetMinimumOutput()->Get(); }
  PixelValueObjectType * GetMinimumOutput();

  const PixelValueObjectType * GetMinimumOutput() const;

  /** Return the computed Maximum. */
  PixelValueType GetMaximum() const
  { return this->GetMaximumOutput()->Get(); }
  PixelValueObjectType * GetMaximumOutput();

  const PixelValueObjectType * GetMaximumOutput() const;
...
protected:
  ...
  ~MaskedStatisticsImageFilter() override = default;
...
private:
  ...
  PixelValueType     m_ThreadMin;
  PixelValueType     m_ThreadMax;
