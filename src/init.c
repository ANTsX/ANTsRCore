...
/*
  ...
  e.g., with different numbers of arguments:
    ...
    antsrMetric
    integrateVelocityField (in R; cpp fns differ by ANTS* prefix)
...
extern SEXP extractSlice(SEXP, SEXP, SEXP, SEXP);
...
extern SEXP ANTSIntegrateVectorField(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);

/* Old ANTsR .Call calls */
...
extern SEXP fitThinPlateSplineDisplacementField(SEXP, SEXP, SEXP, SEXP, SEXP, SEXP, SEXP);
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"extractSlice",                            (DL_FUNC) &extractSlice,                             4},
    ...
    {"fitThinPlateSplineDisplacementField",     (DL_FUNC) &fitThinPlateSplineDisplacementField,    7},
